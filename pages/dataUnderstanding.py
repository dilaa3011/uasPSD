...
def html():
    ...
    <div class="container">
        <div class="card mt-3">
            <div class="card-body">
                Wine merupakan minuman beralkohol yang terbuat dari hasil fermentasi anaerob jus buah anggur tanpa kehadiran O2. Keseimbangan sifat alami yang terkandung pada buah anggur dapat menyebabkan buah tersebut difermentasi tanpa penambahan gula, asam, enzyme, maupun nutrisi lain. Pembuatan wine dengan cara fermentasi jus buah anggur ini menggunakan khamir tertentu yang kemudian kandungan gula yang ada pada buah anggur tersebut akan dikonsumsi oleh yeast (ragi) dan mengubahnya menjadi alkohol. Jenis anggur yang berbeda dan strain khamir yang digunakan, tergantung pada jenis wine yang akan di produksi. Dalam memproduksi wine, komposisi yang digunakan harus mempunyai kandungan nutrisi tinggi, mempunyai keasaman yang tinggi sehingga dapat menghambat pertumbuhan mikroba yang tidak diinginkan, kandungan gula cukup tinggi dan aroma yang sedap, oleh itu kualitas wine harus diutamakan.
            </div>
        </div>
        <br>
